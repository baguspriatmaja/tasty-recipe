      ...
      <form @submit.prevent="addNewRecipe">
        ...
        <div>
          ...
          <div>
            ...
            <!-- Recipe Title Start -->
            <div class="mb-3">
              <base-input type="text" identity="recipeTitle" placeholder="Give your recipe a title" label="Title Recipe" v-model="recipeData.name"></base-input>
            </div>
            <!-- Recipe Title  End -->
        ...
        <div class="border-top my-3">
          ...
          <div>
            <div class="mb-3 row" v-for="count in directionCount" :key="count">
              ...
              <div class="col-lg-11 col-11">
                <base-input type="text" identity="direction" placeholder="Ex: 1 cup sugar" v-model="recipeData.directions[count - 1]"></base-input>
              </div>
               <!-- Direction Input End -->
              <div
                class="col-lg-1 col-1 col-form-label align-self-end delete-ingredient"
